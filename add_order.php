					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								echo form_dropdown('client_id',$client_data,$client_id,'class="form-control select2me" id="client_id" tabindex="0" placeholder= "Select Product" required="required"');?>				  
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								echo form_dropdown('state_code',$gst_state_codes,27,'class="select2me form-control" required="required" tabindex="0"');?> 
								<span class="help-block help-block-error" for="state_code" style="color:#F30;"><?php echo form_error('state_code'); ?></span>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label" for="gst_num"> GST No <span class="required" aria-required="true"> *</span></label>
								<?php 
					...
					<div class="row"> 
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								echo form_dropdown('is_gst',$gst_array,'no','class="form-control select2me" id="is_gst" tabindex="0" placeholder= "Select Product" required="required"');?>				  
					...
					<tbody id="tableBody">
						<tr class="gradeX short odd" id="order_products">
							<td>
								...
								echo form_dropdown('product_id[]',$productListArray,'','class="auto form-control productdata" tabindex="0" id="product_id_1" placeholder= "Select Model" required="required" '); ?>
								<input type="hidden" class="form-control" id="rownums" name="rownums" value= "1" required="required" />
							</td>		
							<td> <input type="number" class="form-control" name="product_qty[]" min="0" id="product_qty_1" value= "" placeholder= "Ex. 1000" required="required" /></td>

							<td> <input type="text" class="form-control" name="product_unit[]" id="product_unit_1" value= "" placeholder= "Unit" required="required" /></td>	
							
							<td> <input type="text" class="form-control" name="product_rate[]" min="0" id="product_rate_1" value= "" placeholder= "EX. 100" required="required" /></td>

							<td> <?php
								$product_gst = set_value('product_gst');			  
								echo form_dropdown('product_gst[]',$data_gst_per,'','class="form-control" tabindex="0" id="product_gst_1" placeholder= "Select GST" required="required" '); ?>
							</td>
							<td> <input type="text" class="form-control" name="product_discount[]"  id="product_discount_1" value= "" placeholder= "Discount %" required="required" /> </td>
